...
role_arn = aws_iam_role.tessolve.arn
vpc_config {
...
depends_on = [
aws_iam_role_policy_attachment.tessolve-AmazonEKSClusterPolicy,
aws_iam_role_policy_attachment.tessolve-AmazonEKSVPCResourceController,
]
}
resource "aws_eks_node_group" "tessolve" {
cluster_name = aws_eks_cluster.tessolve.name
node_group_name = var.node_group_name
node_role_arn = aws_iam_role.tessolve2.arn
subnet_ids = var.aws_public_subnet
...
depends_on = [
aws_iam_role_policy_attachment.tessolve-AmazonEKSWorkerNodePolicy,
aws_iam_role_policy_attachment.tessolve-AmazonEKS_CNI_Policy,
aws_iam_role_policy_attachment.tessolve-AmazonEC2ContainerRegistryReadOnly
,
]
}
...
role = aws_iam_role.tessolve.name
}
...
role = aws_iam_role.tessolve2.name
}
